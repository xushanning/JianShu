...
public class SmileView extends View {
    ...
    private void init(Context context, AttributeSet attrs) {
        TypedArray mTypedArray = context.obtainStyledAttributes(attrs,
                R.styleable.JSmileView);

        //获取自定义属性和默认值
        radius = mTypedArray.getInteger(R.styleable.JSmileView_j_smile_radius, 15);
        lineWidth = mTypedArray.getInteger(R.styleable.JSmileView_j_smile_line_width, 5);
        animDuration = mTypedArray.getInteger(R.styleable.JSmileView_j_smile_duration, 2000);
